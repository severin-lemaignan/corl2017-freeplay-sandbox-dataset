...
%CERE: do you need to define DoF or is it obvious?
...
%CERE: ``question'' to me seemed negative
...
%CERE: ``recognition'' confused me as it's a type of memory paradigm -- possibly that's irrelevant to this audience though
...
applications.
%CERE: you've already said most of this, perhaps it could be cut?
...
\begin{figure}[ht!]
    ...
    detected 68 facial features, visualised in RViz.}
...
The experimental setup is visible in Fig.~\ref{fig|freeplay}, left.  The experimenter
...
are extracted and reprojected onto the 3D point-clouds (Fig.~\ref{fig|rviz}). Faces have been successfully detected in 56\% of the recorded frames
